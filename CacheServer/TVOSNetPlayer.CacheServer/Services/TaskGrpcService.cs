...
public sealed class TaskGrpcService : TaskService.TaskServiceBase
{
    ...
    public override System.Threading.Tasks.Task WatchTasks(WatchTasksRequest request, IServerStreamWriter<TaskEvent> responseStream, ServerCallContext context)
    {
        throw new RpcException(new Status(StatusCode.Unimplemented, "Task watching is not implemented in this slice."));
    }
